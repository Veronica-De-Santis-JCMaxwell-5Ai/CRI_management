<html>
	...
	<body>
		...
		<dir>
			<button class="btn" onclick="location.replace('trasporti.html');">TRASPORTI</button>
		...
		<dir>
			...
			<div id = "dialisi">
				<form method = "post" action = "sendToDialisi.php">
					<div style="background-color:#666;">
					...
					<div class = "login-form">
						...
						<div class = "control-group">
							<input type = "text" value = "Affiancato" name = "Affiancato" id = "Affaincato" onFocus="this.value = ''" onchange = "deleteOnFocus('Affiancato')" required>
						</div>
					</div>
					<div style="background-color:#666;">
					...
					<div class = "login-form">
						...
						<div class = "control-group">
							<input type = "text" value = "Nazionalita'" name = "Nazionalita" id = "nazionalita" onFocus = "this.value = ''" onchange = "deleteOnFocus('nazionalita')" required>
						</div>
						<div class = "control-group">
					...
					<div class = "login-form">
						...
						<div class = "control-group">
							<input type = "text" value = "Durata: " name = "Durata" id = "durata" onFocus="this.value = ''" onchange = "deleteOnFocus('durata')" required>
						</div>
